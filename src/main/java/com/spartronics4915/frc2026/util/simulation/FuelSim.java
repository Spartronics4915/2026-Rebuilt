...
public class FuelSim {
     ...
     */
    public void launchFuel(LinearVelocity launchVelocity, Angle hoodAngle, Angle turretYaw, Translation3d translation) {
        ...
        Pose3d launchPose = new Pose3d(this.robotPoseSupplier.get())
                .plus(new Transform3d(translation, Rotation3d.kZero));
